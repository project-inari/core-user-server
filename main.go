// Package main is the main entry point for core-user-server service
package main
...
import (
	...
	"github.com/project-inari/core-user-server/di"
	"github.com/project-inari/core-user-server/middleware"
)
